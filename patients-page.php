...
//スタッフネーム取得
$userName = getPatiName($p_id);
//debug(print_r($userName,true));


//伝達情報を取得する
$viewData = getPatiTaskData($p_id , $which , $sort , $currentMinNum);
                        ...
                        <div class="task-card">
                            ...
                            <div class="task-card-head">
                                ...
                                <div class="card-maindata">
                                    <div class="task-data">
                                        <h4><?php echo $missons[$i]->getName(); ?></h4>
                                    </div>
                                    <div class="task-days">
